...
// Functions determine how the data appears on the display.
...
const displayDataFunc = (allToolsData) => {
  ...
  // The function works on how to display data in an ascending manner by date.
  ...
  // How to first show 6 data and then how to make the button visible through condition
...
// Function to display only the data.
...
// The function's job is to fetch data by dynamic ID
...
// The function is to display the data of dynamic id through a modal.
